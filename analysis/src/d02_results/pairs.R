...
# firm minus those of its control; Wilcoxon signed-rank test (main) and paired t-test. Matched samples
# of the main text and of the appendix (market value and price).
...
for (sample in c("matched", "matched_dk")) {
...
cat(sprintf("[pairs|%s] %s pairs with data before and after the invasion\n", sample, format(nrow(pairs), big.mark = ",")))
