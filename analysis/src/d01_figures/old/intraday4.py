...
INTRADAY    = DATA_ROOT / "intraday.csv"
OUT_DIR     = OUTPUT_ROOT / "intraday" / "figures"
OUT_DIR.mkdir(parents=True, exist_ok=True)

# ---------- READ ----------
usecols = ["ric", "datetime", "qspread_mean", "nbr_1_or_2"]
df = pd.read_csv(INTRADAY, usecols=usecols, low_memory=False)
