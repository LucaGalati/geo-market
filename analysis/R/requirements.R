...
pkgs <- c(
  "arrow", "data.table", "dplyr", "tibble", "readr", "lubridate", "zoo",
  "plm", "fixest", "lfe", "lmtest", "sandwich", "multiwayvcov", "car",
  "broom", "moments", "texreg", "xtable", "kableExtra", "knitr", "modelsummary"
)
